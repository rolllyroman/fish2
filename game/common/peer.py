...
class Peer(WebSocketServerProtocol, GameObject):
    ...
    def onOpen(self):
        ...
        if self.hashKey:
            ...
            # log("factory:", LOG_LEVEL_RELEASE)
            # log(str(self.factory), LOG_LEVEL_RELEASE)
            # log("="*66, LOG_LEVEL_RELEASE)
            # log("lastPacketTimestamp:", LOG_LEVEL_RELEASE)
            # log(str(self.lastPacketTimestamp), LOG_LEVEL_RELEASE)
            # log("="*66, LOG_LEVEL_RELEASE)
    ...
    def onMessage(self, payload, isBinary):
        ...
        try:
            ...
            if isCheckTimestamp:
                ...
                # print timestamp
                # print('='*66)
                # print 'self.firstPacketTimestamp:'
                # print self.firstPacketTimestamp
                # print('='*66)
