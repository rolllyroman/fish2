...
from common.protocols.mahjong_consts import LANG_CODE
...
REG_TIPS_INVALID_PASSWD = "密码不合法（必须为总长度8-20的合法字符）。".decode(LANG_CODE)
...
LOGIN_TIPS_INVALID_ACCOUNT = "登录失败，账号已被冻结，请联系客服。".decode(LANG_CODE)
...
DISCONNECTED_TIPS_FREEZE = "你的账号已被管理员冻结，请咨询客服了解详请。".decode(LANG_CODE)
DISCONNECTED_TIPS_REPEAT_LOGIN = "你的账号已从其它位置登录，请咨询客服了解详情。".decode(LANG_CODE)
