...
<div class='content'>
      <form class='form-horizontal group-border-dashed' action="{{info['submitUrl']}}" method='POST'  >
       ...
       <div class="form-group">
            <label class="col-sm-5 col-xs-10 control-label">预设值</label>
       ...
       <div class="form-group">
            <label class="col-sm-5 col-xs-10 control-label">大于预设值下的捕获率</label>
            <div class="col-sm-6 col-xs-12">
       ...
       <div class="form-group">
            <label class="col-sm-5 col-xs-10 control-label">小于预设值下的捕获率</label>
            <div class="col-sm-6 col-xs-12">
