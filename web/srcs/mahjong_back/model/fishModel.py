...
def getFishCoinAndWarheadStatis(redis):
    res = {
            ...
            "data":[{
                ...
                "produce_coin":redis.get('produce:coin:sum'),
                "earnings_coin":redis.get('earnings:coin:sum'),
                "produce_warhead":redis.get('produce:warhead:sum'),
                "earnings_warhead":redis.get('earnings:warhead:sum'),
                "coin_rate":redis.get('fish:coin:rate'),
                "warhead_rate":redis.get('fish:warhead:rate'),
                "preset_value":redis.get('fish:preset:value'),
